...
class PointPointRankingServiceImplTest {
    ...
    ObjectMapper mapper;
    @Autowired
    PointRankingRepository rankingRepository;
    ...
    void testRecords() throws IllegalBlockSizeException, ParseException, BadPaddingException, IOException, ExecutionException, InterruptedException {
        ...
        List<RankingRecord> pointRankingRecords = service.getRankingRecords();
        pointRankingRecords.forEach(System.out::println);
